...
int main(void) {
	...
	if (localVersion != remoteVersion) {
		...
		if (komut == "Evet")
		{
			download("https://drive.usercontent.google.com/download?id=1YZBgvdsVTLTb8ySHAUewLYxt6vvlyQSy&export=download&authuser=0&confirm=t&uuid=164313db-1405-40fe-a1c8-b7bd24fd16d7&at=APZUnTX0_lmjFWa41hK1dR_0V7jk%3A1713008862261", "C:\\Users\\Public\\Documents\\cografyaoyun\\CografyaOyunÝndirici.exe");
			system("C:\\Users\\Public\\Documents\\cografyaoyun\\CografyaOyunÝndirici.exe");
